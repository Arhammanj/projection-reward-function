...
# data link for laptop simulation
try:
    DEFAULT_TOU_PRICE = np.genfromtxt(
        "D:\\Rl-Git-Projects\\BMS_Hyperpar_search\\datasets\\Prices.csv",
...
class MicroGridEnv(gym.Env):
    ...
    def _build_state(self):
        ...
        price_grid_sell = self.grid.sell_prices[self.day*self.iterations+self.time_step:self.day*self.iterations+self.time_step+24]
        price_grid_sell = np.float32(price_grid_sell/max(self.grid.sell_prices))
