...
Full pipeline for the 5000-episode projection-reward run:
  ...
  4. Generate 3 styled figures (matching the v2_*_STYLED look):
       - v2_train_convergence_1000_STYLED.png  (Fig. 2 equivalent, 5000 ep)
       - v2_day310_1000_STYLED.png              (price / SOC / power, Day 310)
       - v2_daily_profit_1000_STYLED.png        (daily trading profit, days 300-364)
...
# ══════════════════════════════════════════════════════════════════════════
print("Training agent on days 0-299 (1000 episodes, projection reward)...")
...
# ══════════════════════════════════════════════════════════════════════════
# Fig A — Training convergence, full 1000 episodes
# ══════════════════════════════════════════════════════════════════════════
print("\nBuilding training convergence figure (1000 episodes)...")
WINDOW = 50
...
fig.suptitle("Fig. 2. Training reward and operating cost convergence — Reward v2 (Projection-Aware), 1000 episodes",
             fontsize=14, fontweight='bold')
fig.tight_layout(rect=[0, 0, 1, 0.96])
out1 = Path('v2_train_convergence_1000_STYLED.png')
...
fig.suptitle(f"Fig. 6. Battery operation on Day {DAY} — Reward v2 (Projection-Aware), 1000-episode training",
             fontsize=14, fontweight='bold')
fig.tight_layout(rect=[0, 0, 1, 0.96])
out2 = Path('v2_day310_1000_STYLED.png')
...
style_title(ax, "Fig. 9. Daily trading profit on unseen test days 300-364 — Reward v2 (Projection-Aware), 1000-episode training")
ax.set_xlabel("Day")
ax.set_ylabel("Profit (£)")
style_axes(ax)
add_legend(ax)
fig.tight_layout()
out3 = Path('v2_daily_profit_1000_STYLED.png')
